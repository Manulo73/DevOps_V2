...
export default function SidebarMenu({ isOpen, onClose }) {
  return (
    <div className={`${styles.extension} ${isOpen ? styles.open : ""}`}>
        <div className={`${styles.sidebarMenu} ${isOpen ? styles.open : ""}`}>

            <div className={styles.top_container}>
                <div>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={styles.icon} onClick={onClose}>
                        <path d="M3 18H21" stroke="#3F72AF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                        <path d="M3 12H21" stroke="#3F72AF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                        <path d="M3 6H21" stroke="#3F72AF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                    <Image 
                        src="/images/logo.png" 
                        alt="Logo" 
            ...
            <div className={styles.sidebar_container}>
                <div>
                    <Link href={ directions.Dashboard } className={styles.link}>
            ...
            <div className={styles.sidebar_container}>
                <div>
                    <Link href={ directions.Incidents } className={styles.link}>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={styles.icon}>
            ...
            <div className={styles.sidebar_container}>
                <div>
                    <Link href={ directions.Technician } className={styles.link}>
            ...
            <div className={styles.sidebar_container}>
                <div>
                    <Link href={ directions.Client } className={styles.link}>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className={`${styles.background} ${isOpen ? styles.open : ""}`} onClick={onClose}></div>
    </div>
  );
}